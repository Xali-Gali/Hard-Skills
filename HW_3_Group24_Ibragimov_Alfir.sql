...
join roles_employee on employees.id = roles_employee.id_employee
join roles on roles.id = roles_employee.id_role
...
join roles_employee on employees.id = roles_employee.id_employee
join roles on roles.id = roles_employee.id_role
where role_name like '%Avtomation QA engineer%';
...
join roles_employee  on employee_salary.employee_id = roles_employee.id_employee
join roles on roles.id = roles_employee.id_role
where role_name like '%Java developer%';
...
join roles_employee on roles_employee.id_employee = employees.id 
join roles on roles.id = roles_employee.id_role
where role_name like '%Middle Java developer%';
